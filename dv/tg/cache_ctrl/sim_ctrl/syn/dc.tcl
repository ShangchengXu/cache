...
set_input_delay -max [expr $Period(300M) * 0.3] -clock clk [remove_from_collection [all_inputs] [get_ports clk]]
set_input_delay -min [expr $Period(300M) * 0.0] -clock clk [remove_from_collection [all_inputs] [get_ports clk]]

set_output_delay -max [expr $Period(300M) * 0.3] -clock clk [all_outputs]
